...
describe('test position is free', () => {
  it('should test position is not free', () => {
    ...
    const tileTwo: Tile = {id: 1, shape: Shape.Square, color: Color.Purple, x: 1, y: 1, disabled: true};
  ...
  it('should test position is free', () => {
    ...
    const tileThree: Tile = {id: 3, shape: Shape.Square, color: Color.Purple, x: 2, y: 0, disabled: true};
    const rowTile: Tile[] = [tileTwo, tileOne];
    expect(positionIsNotFree(rowTile,tileThree)).toBeFalsy()
  });
  it('should test position is free and position y is not the same', () => {
    const tileOne: Tile = {id: 1, shape: Shape.Circle, color: Color.Purple, x: 0, y: 1, disabled: true};
    const tileTwo: Tile = {id: 2, shape: Shape.Square, color: Color.Purple, x: 1, y: 0, disabled: true};
    const tileThree: Tile = {id: 3, shape: Shape.Square, color: Color.Purple, x: 0, y: 0, disabled: true};
    const rowTile: Tile[] = [tileTwo, tileOne];
    expect(positionIsNotFree(rowTile,tileThree)).toBeFalsy()
  });
  it('should not set position is free', () => {
    const tileOne: Tile = {id: 1, shape: Shape.Circle, color: Color.Purple, x: 0, y: 0, disabled: true};
    const tileTwo: Tile = {id: 2, shape: Shape.Square, color: Color.Purple, x: 0, y: 0, disabled: true};
    const tileThree: Tile = {id: 1, shape: Shape.Square, color: Color.Purple, x: 2, y: 0, disabled: true};
    const rowTile: Tile[] = [tileTwo, tileOne];
  ...
  it('should test position is free for positionisfree and id the same', () => {
    const tileOne: Tile = {id: 1, shape: Shape.Circle, color: Color.Purple, x: 0, y: 0, disabled: true};
    const tileTwo: Tile = {id: 2, shape: Shape.Square, color: Color.Purple, x: 0, y: 0, disabled: true};
    const tileThree: Tile = {id: 1, shape: Shape.Square, color: Color.Purple, x: 2, y: 1, disabled: true};
    const rowTile: Tile[] = setPositionTile([tileTwo], tileOne);
    expect(positionIsFree(rowTile,tileThree)).toBeTruthy()
  });
  it('should test position is free for positionisfree and id the same but  y too', () => {
    const tileOne: Tile = {id: 1, shape: Shape.Circle, color: Color.Purple, x: 0, y: 0, disabled: true};
    const tileTwo: Tile = {id: 2, shape: Shape.Square, color: Color.Purple, x: 0, y: 0, disabled: true};
    const tileThree: Tile = {id: 1, shape: Shape.Square, color: Color.Purple, x: 0, y: 0, disabled: true};
    const rowTile: Tile[] = setPositionTile([tileTwo], tileOne);
